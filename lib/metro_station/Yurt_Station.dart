...
import 'package:akillikentclone/metro_tabs/Yurt_station_tabs/Akincilar-yurt.dart';
import 'package:akillikentclone/metro_tabs/Yurt_station_tabs/Yurt-Akincilar.dart';
import 'package:flutter/material.dart';

class YurtStation extends StatelessWidget {
  const YurtStation ({Key? key}) : super(key: key);
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            ...
            title: const Text('YURT İSTASYONU'),
            bottom: const TabBar(

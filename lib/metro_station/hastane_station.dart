...
import 'package:akillikentclone/metro_tabs/Anadolu_lisesi_station_tabs/AnadoluLisesi-Ak%C4%B1nc%C4%B1lar.dart';
...
class HastaneStation extends StatelessWidget {
  const HastaneStation({Key? key}) : super(key: key);
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('HASTANE İSTASYONU'),
          bottom: const TabBar(
